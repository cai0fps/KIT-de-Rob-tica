...
Blockly.Blocks.base.HUE ="#19A15F";//'#ae3838';//40;
Blockly.Blocks.base.scratch_3 ="#19A15F";
...
*/
Blockly.Blocks['readControlIR_1'] = {
  init: function() {
    this.appendDummyInput()
    
        .appendField("leitura do sensor IR da Porta: ")
        .appendField(new Blockly.FieldDropdown([["P5","1"], ["P6","2"], ["P7","3"], ["P8","4"], ["M1","5"], ["M2","6"], ["M3","7"], ["M4","8"]]), "port")
        .appendField("canal")
        .appendField(new Blockly.FieldDropdown([["Canal_1","1"], ["Canal_2","2"], ["Canal_3","3"], ["Canal_4","4"]]), "channel");
    this.setColour(Blockly.Blocks.base.scratch_3);
 this.setTooltip("");
 this.setHelpUrl("");
 this.setInputsInline(true);
...
Blockly.Blocks['readColorEv3'] = {
  init: function() {
    this.appendDummyInput()
    
        .appendField("leitura do sensor de Cor: ")
        .appendField(new Blockly.FieldDropdown([["P5","P5"], ["P6","P6"], ["P7","P7"], ["P8","P8"], ["M1","M1"], ["M2","M2"], ["M3","M3"], ["M4","M4"]]), "port")
        .appendField("função")
        .appendField(new Blockly.FieldDropdown([["REFLETIVO","REFLETIVO"], ["AMBIENTE","AMBIENTE"], ["COR","COR"]]), "mode");
    this.setColour(Blockly.Blocks.base.scratch_3);
 this.setTooltip("");
 this.setHelpUrl("");
 this.setInputsInline(true);
...
Blockly.Blocks.inout_analog_write = {
  init: function() {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip(Blockly.MIXLY_TOOLTIP_INOUT_ANALOG_WRITE_RAFA);
    this.setHelpUrl("https://www.youtube.com/watch?v=PJrnTHivzds");
    this.wiki = {
      'zh-hans': {
...
Blockly.Blocks.inout_analog_read = {
  init: function() {
    this.setColour(Blockly.Blocks.base.HUE);
    this.appendValueInput("PIN", Number)
    .appendField(Blockly.MIXLY_ANALOGREAD_PIN) //Blockly.MIXLY_ANALOGREAD_PIN
    .setCheck(Number);
    this.setInputsInline(true);
