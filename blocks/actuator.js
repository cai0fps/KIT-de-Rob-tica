...
Blockly.Blocks.actuator.MOTOR = "#708090";
Blockly.Blocks.actuator.VOICE = "#D65CD6";
Blockly.Blocks.actuator.LIGHT = "#9966FF";

Blockly.Blocks.servo_move = {
  init: function () {
    this.setColour(Blockly.Blocks.actuator.MOTOR);
...
Blockly.Blocks.tone_notes = {
  init: function () {
    this.setColour(Blockly.Blocks.actuator.VOICE);
    this.appendDummyInput("")
...
Blockly.Blocks.controls_tone = {
  ...
  Blockly.Blocks.RGB_color_seclet = {
    init: function () {
      this.setColour(Blockly.Blocks.actuator.LIGHT);
      this.appendDummyInput("")
      .setAlign(Blockly.ALIGN_RIGHT)
