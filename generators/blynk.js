...
Blockly.Arduino.blynk_server = function () {
	...
	//Blockly.Arduino.definitions_['define_BLYNK_PRINT_'] = '#define BLYNK_PRINT Serial';

	Blockly.Arduino.definitions_['include_ESP8266WiFi_'] = '#define BLYNK_PRINT Serial\n #include <ESP8266_Lib.h>';
	Blockly.Arduino.definitions_['include_BlynkSimpleEsp8266_'] = '#include <BlynkSimpleShieldEsp8266.h>';

	Blockly.Arduino.definitions_['var_declare_wifi_ssid_'] = 'char ssid[] = ' + wifi_ssid + ';';
	Blockly.Arduino.definitions_['var_declare_wifi_pass_'] = 'char pass[] = ' + wifi_pass + ';\n';
	Blockly.Arduino.definitions_['var_declare_auth_key_'] = 'char auth[] = ' + auth_key + ';\n';

	//	if (board_type.match(RegExp(/AVR/))) {
	Blockly.Arduino.definitions_['var_declare_ESP8266_'] = 'ESP8266 wifi(&Serial3);';
	Blockly.Arduino.setups_['setup_serial_Serial_'] = 'Serial.begin(9600);';
	Blockly.Arduino.setups_['delay_10_1_'] = 'delay(10);';
	Blockly.Arduino.setups_['wifi.Serial3'] = 'Serial3.begin(115200);';
	Blockly.Arduino.setups_['delay_10_2_'] = 'delay(10);';
	Blockly.Arduino.setups_['wifi.setOprToStation'] = 'wifi.setOprToStation(2, 2);';
	Blockly.Arduino.setups_['delay_10_3_'] = 'delay(10);';
	Blockly.Arduino.setups_['wifi.enableMUX_'] = 'wifi.enableMUX();';
	Blockly.Arduino.setups_['delay_10_4_'] = 'delay(10);';
	Blockly.Arduino.setups_['setup_Blynk.begin_'] = 'Blynk.begin(auth, wifi, ssid, pass);';
	//}
	if (!isNaN(server_add.charAt(2))) {
		server_add = server_add.replace(/\"/g, "").replace(/\./g, ",");
		server_add = 'IPAddress(' + server_add + ')';
