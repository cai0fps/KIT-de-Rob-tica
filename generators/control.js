...
Blockly.Arduino.controls_delay_ED = function () {
    var delay_time = Blockly.Arduino.valueToCode(this, 'DELAY_TIME', Blockly.Arduino.ORDER_ATOMIC) || '1000'
    var unit = this.getFieldValue('UNIT');
    var code = unit + '(' + delay_time + ');\n';
    return code;
...
Blockly.Arduino.controls_end_program_ED = function () {
    var board_type = Mixly.JSFuncs.getPlatform();
    if (board_type.match(RegExp(/ESP8266/)))
        return 'while(true) delay(1000);\n';
    else
        return 'flagLoopAluno = false;\n';
};
...
Blockly.Arduino.simple_timer = function () {
    ...
    Blockly.Arduino.definitions_['var_declare_SimpleTimer'] = 'SimpleTimer timer2;';
    Blockly.Arduino.setups_[funcName] = 'timer2.setInterval('+ timein * 1000 +'L, '+funcName+');\n';
    return 'timer2.run();\n';
};
...
Blockly.Arduino.execute_super_delay_function1 = function() {
    ...
    var code='timer2.setTimer('+ time_interval+', super_delay_function'+ number+', '+ frequency+');\n';
    return code;
};