...
Blockly.Arduino.inout_digital_write2 = function () {
    ...
    Blockly.Arduino.setups_['setup_inputDigCit' + dropdown_pin] = 'pinMode(' + dropdown_pin + ', OUTPUT);';
...
Blockly.Arduino.inout_analog_read = function () {
    ...
    if (typeof analog === 'object') {
        for (let i of analog)
            if (dropdown_pin === i[1]) {
                Blockly.Arduino.setups_['setup_output'+dropdown_pin] = 'pinMode('+dropdown_pin+', INPUT_PULLUP);';
                break;
            }
    }
