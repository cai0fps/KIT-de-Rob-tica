...
Blockly.Arduino.readControlIR_1 = function () {

    var dropdown_port = this.getFieldValue('port');
    var dropdown_channel = this.getFieldValue('channel');

    Blockly.Arduino.definitions_['includeEV3'] = '#include "sensorEV3.h"';

    var code = 'controleRemoto('+dropdown_port+','+dropdown_channel+')';
    

    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.readColorEv3 = function () {
    ...
    var code = 'sensorCorEV3('+dropdown_port+','+dropdown_mode+')';
